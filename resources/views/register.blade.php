  ...
  <body class="text-center">
    ...
    <form action="/register" method="POST">
        ...
        <div class="form-floating">
            <input type="text" name="email" class="form-control mb-2" id="floatingInput" placeholder="name@example.com" required>
            <label for="floatingInput">Email</label>
        </div>
        <div class="form-floating">
          <select class="form-select mb-2" name="role" aria-label="Default select example"  placeholder="name@example.com">
            <option value="User">User</option>
            <option value="Admin">Admin</option>
          </select>
          <label for="floatingInput">Type Account</label>
        </div>
        <div class="form-floating">
        ...
        <small class="d-text-center">Have an Account?? <a href="/login">Login</a>.</small>
    </form>
    </main>
